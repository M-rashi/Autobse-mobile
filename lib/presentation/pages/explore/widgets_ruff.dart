...
//           children: [
//             _buildServiceItem(icon: Icons.show_chart, label: 'Live Auctions'),
//             _buildServiceItem(
//                 icon: Icons.calendar_today, label: 'Upcoming Auctions'),
//             _buildServiceItem(
//                 icon: Icons.local_shipping, label: 'Sell my truck'),
//           ],
//         ),
//       ],
//     );
